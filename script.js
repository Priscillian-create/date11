        ...
        products.forEach(product => {
            ...
            if (product.stock <= settings.lowStockThreshold) {
                lowStockProducts.push({
                    ...
                    currentStock: product.stock,
                    threshold: settings.lowStockThreshold,
                    message: `Low stock: ${product.name} has only ${product.stock} items left (threshold: ${settings.lowStockThreshold})`
                });
            }
            ...
            if (daysUntilExpiry < 0) {
                ...
                expiringSoonProducts.push({
                    ...
                    expiryDate: product.expiryDate,
                    daysUntilExpiry: daysUntilExpiry,
                    message: `Expiring soon: ${product.name} expires in ${daysUntilExpiry} days`
                });
            }
        });
